...
- **Archived URL Collection**  
  Gathers all URLs (optionally including subdomains) from the [Wayback Machine](https://archive.org/web/) for a given domain.

- **Leaked Credentials Lookup**  
  Queries the [BreachCollection](https://breachcollection.com) API to find associated credential leaks using:
  - Domain name.
  - Email domain.
